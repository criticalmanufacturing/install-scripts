...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/criticalmanufacturing/install-scripts/linux-infrasctucture/utils/portal/runInitializeInfrastructure.ps1" -OutFile "./runInitializeInfrastructure.ps1"
